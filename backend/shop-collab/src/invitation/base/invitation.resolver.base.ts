...
export class InvitationResolverBase {
  ...
  async createInvitation(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        byOwner: args.data.byOwner
          ? {
              connect: args.data.byOwner,
            }
          : undefined,

        Invited_User: {
          connect: args.data.Invited_User,
        },
      },
    });
  }
  ...
  async resolveFieldByOwner(
    @graphql.Parent() parent: Invitation
  ): Promise<User | null> {
    const result = await this.service.getByOwner(parent.id);
  ...
  async resolveFieldInvitedUser(
    @graphql.Parent() parent: Invitation
  ): Promise<User | null> {
    const result = await this.service.getInvitedUser(parent.id);
